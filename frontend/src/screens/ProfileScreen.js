...
import { listOrdersOfUser } from '../actions/orderActions';
...
const ProfileScreen = ({ history }) => {
  ...
  const ordersOfUser = useSelector((state) => state.ordersOfUser);
  const { error: errorOrders, orders, loading: loadingOrder } = ordersOfUser;
